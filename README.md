...
Професионална система за фактуриране за български бизнеси. Създавайте фактури, управлявайте клиенти с пълна НАП съвместимост.
...
Автоматично генериране на номер по формат: `YYCCCCNNNNNNИ`
- YY = Година (последните 2 цифри)
- CCCC = Идентификатор на компания
- NNNNNN = Пореден номер (нулира се всяка година)
- И = Контролна буква
