    ...
    <div className="w-full animate-in fade-in duration-300">
      ...
      <form onSubmit={handleSubmit} className="space-y-5">
        ...
        <div className="space-y-2">
          ...
          <div className="relative group">
            <div className="absolute inset-y-0 left-0 flex items-center pl-3 pointer-events-none z-10">
              <UserIcon className="h-5 w-5 text-muted-foreground group-focus-within:text-emerald-500 transition-colors duration-200" />
            </div>
            <Input
              id="name"
              name="name"
        ...
        <p className="text-xs text-muted-foreground text-center">
          ...
          <Link href="/terms" className="text-emerald-600 hover:text-emerald-500 underline-offset-4 hover:underline transition-colors duration-200">Условия за ползване</Link>
          {" "}и{" "}
          <Link href="/privacy" className="text-emerald-600 hover:text-emerald-500 underline-offset-4 hover:underline transition-colors duration-200">Политика за поверителност</Link>.
        </p>
