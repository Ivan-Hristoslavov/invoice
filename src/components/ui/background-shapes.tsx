      ...
      {showShapes && (
        <>
          ...
          <div className="animate-orb-rotate absolute bottom-[40%] left-[35%] blur-lg">
            <div className="h-4 w-16 rounded-full bg-indigo-500/10 dark:bg-indigo-400/10" />
            <div className="absolute top-1/2 left-1/2 h-16 w-4 -translate-x-1/2 -translate-y-1/2 rounded-full bg-indigo-500/10 dark:bg-indigo-400/10" />
          </div>
...
export function BackgroundGradient({ className = "" }: { className?: string }) {
  return (
    <div className={`fixed inset-0 -z-10 overflow-hidden pointer-events-none ${className}`}>
      ...
      <div className="absolute inset-0 bg-[linear-gradient(to_right,#00000002_1px,transparent_1px),linear-gradient(to_bottom,#00000002_1px,transparent_1px)] bg-size-[64px_64px] dark:bg-[linear-gradient(to_right,#ffffff01_1px,transparent_1px),linear-gradient(to_bottom,#ffffff01_1px,transparent_1px)]" />
      <div
        className="absolute -top-[40%] -right-[20%] h-[70vw] max-h-[1000px] w-[70vw] max-w-[1000px] rounded-full opacity-60"
        style={{
          background: "radial-gradient(circle, rgba(6, 182, 212, 0.04) 0%, transparent 70%)",
        }}
      />
      <div
        className="absolute -bottom-[30%] -left-[15%] h-[50vw] max-h-[700px] w-[50vw] max-w-[700px] rounded-full opacity-60"
        style={{
