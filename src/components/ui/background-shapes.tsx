...
export function BackgroundShapes({ variant = "default", className = "" }: BackgroundShapesProps) {
  ...
  return (
    <div className={`fixed inset-0 -z-10 overflow-hidden pointer-events-none ${className}`}>
      ...
      {/* Static gradient orbs - no animations for better Safari performance */}
      <div
      ...
      <div
        className="absolute top-[15%] left-[10%] w-16 h-16 rounded-2xl border border-cyan-500/10 dark:border-cyan-400/10 rotate-12"
      ...
      <div
        className="absolute bottom-[20%] left-[20%] w-20 h-20 rounded-3xl border border-cyan-500/8 dark:border-cyan-400/8 -rotate-12"
      />

      <div
        className="absolute top-[35%] right-[25%] w-8 h-8 rounded-lg bg-cyan-500/5 dark:bg-cyan-400/5 rotate-45"
      />
      ...
      <div
        className="absolute top-[25%] left-0 w-full h-px opacity-40"
        style={{
      ...
      <div
        className="absolute bottom-[30%] left-0 w-full h-px opacity-30"
        style={{
