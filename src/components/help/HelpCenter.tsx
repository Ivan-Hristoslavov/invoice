...
const quickLinks: QuickLink[] = [
  ...
  },
  {
    ...
    description: "Самоначисляване на ДДС (ВОП, услуги от ЕС и др.)",
    icon: ClipboardList,
    href: "/vat-protocols-117",
    color: "from-teal-500 to-cyan-600",
    keywords: "протокол 117 зддс воп самоначисляване нап",
  },
  {
...
const faqCategories: FaqCategory[] = [
  ...
  },
  {
    ...
    questions: [
      ...
      {
        q: "Какво е протокол по чл. 117 от ЗДДС?",
        a: "Това е данъчен документ, който при определени доставки с изискуем от получателя ДДС (напр. вътреобщностно придобиване или услуги от ЕС) издава регистрираното лице — получател. В приложението го създавате от менюто „Протокол чл.117“: избирате вашата фирма и доставчика (клиент), сценарий, дати и редове; получавате PDF за счетоводство. Не замества консултация със счетоводител и не е автоматично подаване към НАП, освен ако няма отделна интеграция.",
      },
    ],
  },
  {
