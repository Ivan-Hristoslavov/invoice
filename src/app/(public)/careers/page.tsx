...
export const metadata: Metadata = genMeta({
  title: "Кариери",
  description: "Присъединете се към екипа на FacturaPro и помогнете да опростим фактурирането за българските бизнеси",
});
...
const positions = [
  ...
  },
  {
    ...
    location: "София",
    type: "Пълен работен ден",
    description: "Помогнете на нашите клиенти да постигнат успех с FacturaPro."
  }
];
