...
export const metadata: Metadata = genMeta({
  title: "Функции",
  description: "Разгледайте всички функции на InvoicyPro - професионална система за фактуриране с български данъчни формати",
});
...
const features = [
  {
    ...
    description: "Създавайте елегантни фактури с персонализиран дизайн, автоматично номериране и PDF експорт. Поддръжка на полета и формати по българските данъчни изисквания.",
    details: [
      "Автоматично генериране на последователни номера",
  ...
  {
    icon: Shield,
    title: "Български данъчни формати",
    description: "Поддръжка на задължителни полета, номерация и ДДС реквизити за български фактури.",
    details: [
