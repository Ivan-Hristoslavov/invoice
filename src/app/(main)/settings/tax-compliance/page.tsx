          ...
          <Card>
            ...
            <CardContent className="space-y-4">
              ...
              <ul className="list-disc pl-6 space-y-2">
                ...
                <li>За някои видове фактури може да се изисква електронно подаване — вижте актуалните указания на НАП</li>
                <li>За определени електронни фактури може да се изисква квалифициран електронен подпис — консултирайте се със счетоводител</li>
          ...
          <Card>
            ...
            <CardContent className="space-y-4">
              ...
              <ul className="list-disc pl-6 space-y-2">
                ...
                <li>Определени фактури над определени прагове може да изискват допълнително отчитане — вижте актуалните указания на НАП</li>
              </ul>
              ...
              <Alert className="mt-6">
                ...
                <AlertDescription>
                  Закъснялото подаване на ДДС декларации или неточно отчитане може да доведе до глоби. Размерите се определят от действащото законодателство — консултирайте се с данъчен специалист. Уверете се, че цялата документация е пълна и подадена навреме.
                </AlertDescription>
              </Alert>
            </CardContent>
          </Card>
