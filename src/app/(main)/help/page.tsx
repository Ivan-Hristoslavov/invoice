...
export const metadata: Metadata = {
  ...
  description: "Намерете помощ и документация за използването на Invoicy",
};
...
const faqCategories = [
  {
    ...
    questions: [
      {
        q: "Какво е Invoicy?",
        a: "Invoicy е софтуер за издаване на фактури. Помагаме ви да създавате професионални фактури, да ги изпращате по имейл и да следите кой ви дължи пари."
      },
      {
        q: "Мога ли да приемам плащания чрез Invoicy?",
        a: "Не, Invoicy не е платежна система и не обработва плащания. Плащанията се извършват директно между вас и клиентите ви - чрез банков превод, в брой или друг метод по ваш избор."
      },
      {
        q: "За кого е подходящ Invoicy?",
        a: "Invoicy е идеален за фрийлансъри, малки и средни предприятия, счетоводители, консултанти и всеки, който трябва да издава фактури на клиенти."
      }
    ]
  },
  {
